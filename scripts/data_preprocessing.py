...
def extract_current_mvp_candidates():
    print('pulling 2022 NBA MVP candidates...')
    ...
    #save to data folder
    full_path_current_candidates = data_path + '/data_2022.csv'
    joined_table_2022.to_csv(full_path_current_candidates, index=False)
    print(f"Current season's MVP candidate table has been saved to {full_path_current_candidates}")

if __name__ == "__main__":
    extract_historical_table()
    extract_current_mvp_candidates()